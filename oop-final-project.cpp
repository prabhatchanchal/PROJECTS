...
int main()
{
	...
	do
	{
		...
		case '3':
			...
			break;
		case '4':
			cout<<"\n\n\tEnter The account No. : "; cin>>num; display_sp(num);
			break;
		case '5':
			display_all();
			break;
		case '6':
			cout<<"\n\n\tEnter The account No. : "; cin>>num; delete_account(num);
			break;
		 case '7':
			cout<<"\n\n\tEnter The account No. : "; cin>>num; modify_account(num);
			break;
		 case '8':
...
void intro()
{
	...
	cout<<"MADE BY : PRABHAT KUMAR";
	cout<<"GURU NANAK DEV ENGINEERING COLLEGE";
	cin.get();
}
